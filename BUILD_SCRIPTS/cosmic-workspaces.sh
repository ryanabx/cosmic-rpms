...
path_to_spec='SPECS/cosmic-workspaces.spec'
...
tar -cJf cosmic-workspaces-vendor.tar.xz vendor && mv cosmic-workspaces-vendor.tar.xz ../cosmic-workspaces-vendor.tar.xz
