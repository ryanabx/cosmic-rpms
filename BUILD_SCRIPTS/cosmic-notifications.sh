...
path_to_spec='SPECS/cosmic-notifications.spec'
...
tar -cJf cosmic-notifications-vendor.tar.xz vendor && mv cosmic-notifications-vendor.tar.xz ../cosmic-notifications-vendor.tar.xz
