...
path_to_spec='SPECS/cosmic-settings-daemon.spec'
...
tar -cJf cosmic-settings-daemon-vendor.tar.xz vendor && mv cosmic-settings-daemon-vendor.tar.xz ../cosmic-settings-daemon-vendor.tar.xz
